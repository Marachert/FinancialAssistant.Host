...
Income publishes these shared-envelope v1 events after authoritative state changes:
...
outbox row in one Income-owned PostgreSQL transaction; a RabbitMQ dispatcher retries
