...
- [Windows Server POC deployment](windows-server-poc-deployment.md)
- [POC readiness and closure ledger](../agent/POC_PROGRESS.md)
- [Documentation maintenance gate](../agent/DOCUMENTATION_MAINTENANCE.md)
