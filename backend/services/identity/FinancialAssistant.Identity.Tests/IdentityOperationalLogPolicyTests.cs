...
public sealed class IdentityOperationalLogPolicyTests
{
    ...
    {
        var events = typeof(IdentityOperationalLog)
        ...
        foreach (var item in events)
        {
            ...
            Assert.InRange(attribute.EventId, 2000, 2999);
            Assert.Matches("^Identity[A-Z][A-Za-z0-9]+$", attribute.EventName ?? string.Empty);
